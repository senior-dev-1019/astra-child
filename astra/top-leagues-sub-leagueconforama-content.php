...
>
	...
	<header class="entry-header <?php astra_entry_header_class(); ?>" style='background-image: url(<?php echo get_stylesheet_directory_uri() ?>/assets/images/<?php echo $template_path[0] ?>.jpg); background-repeat: round;'>
		<?php
